...
namespace Laboratorio1_T1_HectorRolandoRevillaFernandez.Controllers
{
    public class VentasController : Controller
    {
        private readonly Laboratorio1_T1_HectorRolandoRevillaFernandezContext _context;

        public VentasController(Laboratorio1_T1_HectorRolandoRevillaFernandezContext context)
        {
            _context = context;
        }
